package com.gitlab.vangora.itemmods.commands;

import com.gitlab.codedoctorde.api.ui.Gui;
import com.gitlab.vangora.itemmods.gui.KnowledgeGui;
import com.gitlab.vangora.itemmods.gui.MainGui;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player)
            if (playerGuiHashMap.containsKey(sender))
                ...
                if(sender.hasPermission("headsadmin.admin"))
